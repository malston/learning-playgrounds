...
- **[llm-inference-infrastructure](llm-inference-infrastructure/)** -- Self-contained HTML playground (1500+ lines, no dependencies) covering 5 interactive sections: VRAM calculator, quantization tradeoffs, parallelism strategy visualizer, buy vs rent decision tool, and MoE vs dense comparison. Live math formulas, GPU hardware recommendations, and copyable configuration summaries for each section. 4 presets (Starter/Team/Production/Enterprise) and inline tooltips on key terms.
